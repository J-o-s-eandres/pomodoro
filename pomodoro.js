...
//Referencia a nuestros elementos
const bAdd = document.querySelector("#bAdd");
const itTask = document.querySelector("#itTask");
const form = document.querySelector("#form");

//visualizar el tiempo al acceder a la pagina
renderTasks();
renderTime();

form.addEventListener("submit", (e) => {
  e.preventDefault(); //anulamos el funcionamiento nativo
...
function createTask(value) {
  const newTask = {
    id: (Math.random() * 100).toString(36).slice(2),//id dinamico
    title: value,
    completed: false,
  };
...
function renderTasks() { //tomar los elementos de las tareas y generar el html que se inyectara en el contenedor
...
function renderTime() { //le daremos formato a un numero
